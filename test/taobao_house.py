...
def buding():
  ...
  cities_list=[u'\u5854\u57ce', u'\u9e70\u6f6d', u'\u4e09\u4e9a', u'\u6069\u65bd', u'\u9e64\u5c97', u'\u9e21\u897f', u'\u5b9c\u5bbe', u'\u5b89\u9633', u'\u901a\u8fbd', u'\u547c\u548c\u6d69\u7279', u'\u9ed1\u6cb3', u'\u6986\u6797', u'\u8302\u540d', u'\u963f\u62c9\u5c14', u'\u53a6\u95e8', u'\u5bbf\u5dde', u'\u963f\u575d', u'\u9ec4\u5188', u'\u6587\u5c71', u'\u6d77\u5317', u'\u63ed\u9633', u'\u4f0a\u6625', u'\u4e09\u95e8\u5ce1', u'\u510b\u5dde', u'\u67f3\u5dde', u'\u4e1c\u839e', u'\u4e09\u660e', u'\u5468\u53e3', u'\u5b89\u5e86', u'\u5fb7\u5b8f', u'\u4e0a\u9976', u'\u4e50\u4e1c', u'\u7389\u6eaa', u'\u4fdd\u4ead', u'\u6b66\u6c49', u'\u6c60\u5dde', u'\u8944\u9633', u'\u5f00\u5c01', u'\u5185\u6c5f', u'\u963f\u62c9\u5584', u'\u4e34\u6c82', u'\u6dee\u5357', u'\u671d\u9633', u'\u968f\u5dde', u'\u9675\u6c34', u'\u5b9a\u897f', u'\u4e34\u6ca7', u'\u5410\u9c81\u756a', u'\u91d1\u660c', u'\u5170\u5dde', u'\u9075\u4e49', u'\u6cf0\u5b89', u'\u5357\u901a', u'\u6dee\u5317', u'\u51c9\u5c71', u'\u961c\u65b0', u'\u677e\u539f', u'\u666f\u5fb7\u9547', u'\u8d35\u9633', u'\u8d35\u6e2f', u'\u5e38\u5dde', u'\u5415\u6881', u'\u4e94\u6307\u5c71', u'\u8346\u5dde', u'\u626c\u5dde', u'\u6d77\u53e3', u'\u6797\u829d', u'\u56db\u5e73', u'\u6500\u679d\u82b1', u'\u8d63\u5dde', u'\u5a01\u6d77', u'\u8346\u95e8', u'\u6d77\u5357\u85cf\u65cf', u'\u4e4c\u9c81\u6728\u9f50', u'\u7389\u6797', u'\u8861\u9633', u'\u6842\u6797', u'\u7ea2\u6cb3', u'\u676d\u5dde', u'\u4e34\u6c7e', u'\u9752\u5c9b', u'\u5305\u5934', u'\u5e7f\u5143', u'\u5e73\u9876\u5c71', u'\u4ed9\u6843', u'\u53f0\u5dde', u'\u7518\u5b5c', u'\u7518\u5357', u'\u9f99\u5ca9', u'\u5e86\u9633', u'\u4fdd\u5c71', u'\u4e2d\u5c71', u'\u6f84\u8fc8', u'\u65b0\u4f59', u'\u5e73\u51c9', u'\u6e56\u5dde', u'\u6e58\u6f6d', u'\u6f2f\u6cb3', u'\u4e50\u5c71', u'\u6dee\u5b89', u'\u4e4c\u6d77', u'\u91cd\u5e86', u'\u7126\u4f5c', u'\u5341\u5830', u'\u77f3\u5634\u5c71', u'\u9999\u6e2f\u5c9b', u'\u5bbf\u8fc1', u'\u5408\u80a5']
...
def formateUrl():
  ...
  starttime='2017-9-1'
  url=base_url+'&support_loans=1'+'&auction_start_from='+starttime+'&auction_start_to=2017-11-30'
  return url
base_url=formateUrl()
...
def delete_db():
  ...
  cur=conn.cursor()
  cur.execute('delete from house_v6')
  cur.close()
  conn.commit()
  conn.close()
...
def insert_db(j):
  try:
    conn=pymysql.connect(**dbconfig)
    cur=conn.cursor()
    sql="insert into house_v6 (province,city,target,currentPrice,bidCount,consultPrice,applyCount,supportOrgLoan,start,end,status,department,startPrice,property,pass_in,itemurl,citynum,company,tel,bank) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
